...
<![endif]-->
  ...
  <![endif]-->
  ...
  </table><table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="34c8cd51-4c87-4fad-a903-e9453968c16f">
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:10px 0px 10px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="200" alt="" data-proportionally-constrained="true" data-responsive="false" src="http://cdn.mcauto-images-production.sendgrid.net/0b9de037936fd873/968521f5-0323-4fbb-ab3c-e47a6f44d79f/623x162.jpeg" height="52">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        ...
        <div><div style="font-family: inherit; text-align: inherit">Dear {{ $data['user'] }},</div>
...
<br><br>We're excited to share the latest job postings advertised in Mihidora with you! These opportunities align with your profile and interests, offering a chance to enhance your career.<br>
Latest Jobs
<table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="34c8cd51-4c87-4fad-a903-e9453968c16f">
  <tbody>
    @foreach ($data['jobs'] as $job)
    <tr>
      <td style="font-size:16px; line-height:10px; padding:10px 0px 10px 0px;" valign="top" align="left">
        <a href="{{ env('APP_URL')}}/resource-exchange-job/{{ $job->slug }}" style="color:#8ea93c; font-weight: 700;">{{ $job->title }}</a> 
      </td>
    </tr>
    @endforeach
  </tbody>
</table>
<br>Don't miss out on these possibilities! Log in to your account to apply or gather more information. Should you need assistance or have questions, don't hesitate to contact our support team at mihidorafeo@gmail.com
<br><br>Wishing you all the best in your career journey!
</span>
</div>
