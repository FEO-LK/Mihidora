  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        ...
        <div><div style="font-family: inherit; text-align: inherit">Dear User,</div>
...
It seems you've forgotten your password for your Mihidora account. No worries, we're here to assist you in regaining access.<br><br>
To reset your password, kindly follow the link below and adhere to the provided instructions:</br><br>
<a href="{{ env('APP_URL') }}/reset-password?token={{ $token }}&email={{ $email }}" > {{ env('APP_URL') }}/reset-password?token={{ $token }}&email={{ $email }} </a>
<br><br>If you did not initiate this request, kindly disregard this email. For further assistance or inquiries, please contact our support team at mihidorafeo@gmail.com. 
</span>
</div>
<div style="font-family: inherit; text-align: inherit"><span style="color: #000000; font-size: 13px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space-collapse: preserve; text-wrap: wrap; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline; font-family: arial, helvetica, sans-serif"> </br><br><br>Best regards,</span></div>
