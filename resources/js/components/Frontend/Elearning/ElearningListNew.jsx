...
function ElearningListNew() {
  ...
  const filterProjects = (data) => {
    ...
    setDataLoad(true);
    axios.get('sanctum/csrf-cookie').then(response => {
      axios.post('/api/get-e-learing-data', {...data, type: 2}).then(res => {
        console.log(res)
        if (res.status == 200) {
          setProjectList(res.data.projects);
          setProjectLoad(false);
    ...
    <BaseLayout title={"Topic"}>
        ...
        <Container>
          <Grid container>
            <Grid item sm={12} md={6} lg={6}>
              <Typography variant="h1">E-Learning Material</Typography>
            </Grid>
            <Grid item sm={12} md={6} lg={6}>
              <div className="section-links">
                ...
                <div style={{ marginRight: '20px' }}><ProjectLink visited name="E-Learning" link={'/elearning-materials'} icon={<AutoStoriesIcon fontSize="small" className="iconVisited" />} /></div>
      ...
      <div id="datasets" className="topic-sub-section">
        <Container>
          ...
          <Grid container>
            <Grid item xs={6}>
              {/* <Typography variant="h4" className="section-title">E-Learning Material</Typography> */}
            </Grid>
...
export default ElearningListNew
