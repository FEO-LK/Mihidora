						...
						<Container>
							<Grid container>
								<Grid item sm={12} md={7} className="section-head" mb={5}>
									<Typography variant="h3" className="section-title"><Typography variant="span">About FEO</Typography>
									Doing more, together for environmental conservation.</Typography> 
								</Grid>
